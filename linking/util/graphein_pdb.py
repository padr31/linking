...
pg = ProteinGraph(granularity='atom', insertions=False, keep_hets=False, intramolecular_interactions=None,
                  ...
                  verbose=True, long_interaction_threshold=5, edge_distance_cutoff=10)

# graph = pg.dgl_graph_from_pdb_code('3eiy', chain_selection='all')

graph = pg._make_atom_graph(pdb_path="/Users/padr/repos/linking/datasets/raw/refined-set/1a1e/1a1e_pocket.pdb")
